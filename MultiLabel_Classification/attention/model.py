...
class StructuredSelfAttention(BasicModule):
    ...
    def __init__(self, batch_size, lstm_hid_dim, d_a, n_classes, label_embed, embeddings):
        ...
        self.lstm = torch.nn.LSTM(
            embeddings.shape[1], hidden_size=lstm_hid_dim, num_layers=1, batch_first=True, bidirectional=True
    ...
    def forward(self,x):
        ...
        embeddings = self.embedding_dropout(embeddings)  # (batch_size, seq_len, embedding_size)
